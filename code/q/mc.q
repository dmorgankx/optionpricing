...
mcEuroCall:{[tst;n;d;pd]exp[neg pd[`r]*pd`t]*avg 0|(last each spath[;n;d;pd]each tst)-pd`k}
mcAsiaCall:{[tst;n;d;pd]exp[neg pd[`r]*pd`t]*avg 0|((*/)each xexp[;1%n]spath[;n;d;pd]each tst)-pd`k}
